...
| 変更後に画面から確認したい | [受け入れ確認と E2E](e2e_testing.md) |
...
| ブラウザ操作で主要機能を確認する | [受け入れ確認と E2E](e2e_testing.md) |
...
画面が開かない、保存できない、AI 提案が出ない、export の内容が想定と違うなどの問題がある場合は、まず [診断と障害調査](diagnostics.md) を確認してください。画面から再現確認をする場合は [受け入れ確認と E2E](e2e_testing.md) を使います。
