...
- `rg -n "Stream H Open化準備 run（2026-04-28）|Phase 1 Read|Phase 2 Plan|Phase 3 Execute|Phase 4 Verify|Phase 5 Proceed|Open化可否" 04_Documentation/e2e_verification_log_2026-03-03.md`
- `git diff --check`
