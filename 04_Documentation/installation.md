...
- 「文書を開く・作成する」パネルが表示され、新規作成、サンプル、文書ファイル、レビューパックの入口を選べる。
...
画面が正常に開くと、次のように作業開始の入口、SafeMode、表示モード、共有と再現、キャンバス、右側の操作パネルが同じ画面内に表示されます。最初の確認では、サンプル文書または新規文書を使い、秘密情報や実データを入力しない状態で確認してください。
