...
SUI_MONKEY_SEED=1 SUI_MONKEY_ACTIONS=150 SUI_MONKEY_VIEWPORT=1440 node ./scripts/monkey_ui_sweep.mjs
SUI_MONKEY_ONLY=A1,A2,A3,A4 node ./scripts/monkey_adversarial_probes.mjs
```
