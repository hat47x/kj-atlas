...
export KJ_ATLAS_DATABASE_URL="${KJ_ATLAS_DATABASE_URL:-${DATABASE_URL:-sqlite:///${ROOT_DIR}/.artifacts/auth-level2/auth_level2.sqlite3}}"
export KJ_ATLAS_ALLOW_JIT_PROVISIONING="${KJ_ATLAS_ALLOW_JIT_PROVISIONING:-true}"
export KJ_ATLAS_AUTH_PROVIDER_PROFILE_DIR="${KJ_ATLAS_AUTH_PROVIDER_PROFILE_DIR:-${AUTH_PROVIDER_PROFILE_DIR:-${ROOT_DIR}/tests/federation/profiles}}"
export AUTH_PROVIDER_PROFILE_DIR="${AUTH_PROVIDER_PROFILE_DIR:-${KJ_ATLAS_AUTH_PROVIDER_PROFILE_DIR}}"
