...
export DATABASE_URL="${DATABASE_URL:-sqlite:///${ROOT_DIR}/.artifacts/auth-level2/auth_level2.sqlite3}"
export ALLOW_JIT_PROVISIONING="true"
export AUTH_PROVIDER_PROFILE_DIR="${AUTH_PROVIDER_PROFILE_DIR:-${ROOT_DIR}/tests/federation/profiles}"
