"""retire superseded content object reference metadata
...
_POLICY = "sui_sensemaking_content_object_references_tenant_isolation"
...
def upgrade() -> None:
    ...
    if row_count:
        raise RuntimeError(
            "content_object_references contains rows; migrate them to content_blobs "
            "or remove confirmed experimental data before upgrading"
        )
