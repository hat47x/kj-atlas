...
SCRIPT_PATH = Path(".github/scripts/lane_c_ratchet_dogfood22_23_legacy_done_once.py")
...
def main() -> None:
    ...
    before = "LEGACY_DONE_AT_ROOT_BASELINE = 29"
    after = "LEGACY_DONE_AT_ROOT_BASELINE = 27"
    if validator.count(before) != 1:
        raise SystemExit("legacy Done baseline 29 を一意に特定できません")
