...
SCRIPT_PATH = Path(".github/scripts/lane_c_ratchet_dogfood18_26_legacy_done_once.py")
...
def main() -> None:
    ...
    before = "LEGACY_DONE_AT_ROOT_BASELINE = 20"
    after = "LEGACY_DONE_AT_ROOT_BASELINE = 18"
    if validator.count(before) != 1:
        raise SystemExit("legacy Done baseline 20 を一意に特定できません")
