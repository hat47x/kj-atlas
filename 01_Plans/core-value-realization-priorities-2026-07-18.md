...
| R6 | 定性カード品質支援の完了（原則P-08: 定性情報への忠実性） | [DOMAIN-CARD-QUALITY-01](issues/issue-DOMAIN-CARD-QUALITY-01-qualitative-card-quality-assistance.md)（PR #2622） | 実装 | AC-3（本文のみ一回保存のE2E、PR審査待ち）、AC-7（分割/言い換えの前後比較と原文復帰）、T8（Phase C要否判断） |
