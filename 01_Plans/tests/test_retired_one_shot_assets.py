...
# DX-CI-STALE-ONESHOT-ASSETS-01 retired these exact files after they had already
# served their one-shot purpose. Keep the guard path-specific: temporary
# validation assets remain allowed elsewhere, while stale branch re-merges must
# not be able to restore these already-completed execution tools silently.
