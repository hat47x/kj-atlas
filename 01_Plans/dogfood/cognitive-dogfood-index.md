...
4. 各実行の事実: 生の成果物、実行記録、SUI Sensemaking InquiryJourney。
5. 本索引: 導線のみを示す。
...
- `doc_sui_sensemaking_dogfood_r1.json` 〜 `doc_sui_sensemaking_dogfood_r5.json`
...
- `doc_sui_sensemaking_dogfood_r11.json`
  - R11のKJキャンバス。
...
- `doc_sui_sensemaking_dogfood_r15.json`
...
- `doc_sui_sensemaking_dogfood_r16.json`
  - R16のKJキャンバス。
...
- `doc_sui_sensemaking_dogfood_r17.json`
  - R17のKJキャンバス。
...
- `doc_sui_sensemaking_dogfood_r18.json`
...
- `doc_sui_sensemaking_dogfood_r19.json`
...
- `doc_sui_sensemaking_dogfood_r20.json`
...
- `doc_sui_sensemaking_dogfood_r21.json`
...
- `doc_sui_sensemaking_dogfood_r22.json`
...
- `doc_sui_sensemaking_dogfood_r23.json`
...
- `doc_sui_sensemaking_dogfood_r24.json`
...
- `doc_sui_sensemaking_dogfood_r25.json`
...
- `doc_sui_sensemaking_dogfood_r26.json`
...
- `doc_sui_sensemaking_dogfood_r27.json`
...
- `doc_sui_sensemaking_dogfood_r28.json`
...
- `doc_sui_sensemaking_dogfood_r29.json`
...
- `doc_sui_sensemaking_dogfood_r30.json`
...
- `doc_sui_sensemaking_dogfood_r31.json`
...
- `doc_sui_sensemaking_dogfood_r32.json`
...
- `doc_sui_sensemaking_dogfood_r33.json`
...
- `doc_sui_sensemaking_dogfood_r34.json`
...
- `doc_sui_sensemaking_dogfood_r35.json`
...
- `doc_sui_sensemaking_dogfood_r36.json`
...
- `doc_sui_sensemaking_dogfood_r37.json`
...
- `doc_sui_sensemaking_dogfood_r38.json`
...
- `doc_sui_sensemaking_dogfood_r39.json`
...
- `doc_sui_sensemaking_dogfood_r40.json`
...
- `doc_sui_sensemaking_dogfood_r41.json`
...
- `doc_sui_sensemaking_dogfood_r42.json`
...
- `doc_sui_sensemaking_dogfood_r43.json`
...
次のものはSUI Sensemaking本体の機能ではなく、比較条件を保つための実験ハーネスである。
...
実験用ツールの不足を、そのままSUI Sensemaking製品の機能不足へ読み替えない。
