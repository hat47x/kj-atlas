...
| `dogfood-log-2026-06-26.md` | ADR-0042最小ドッグフード経路の検証(1回目、バックエンド不在・フロントエンド単体+自動テスト) | 2026-06-26実施 |
| `dogfood-log-2026-07-08.md` | VALUE-DOGFOOD-01フォローアップ(Codexによる代理オペレーター実行、in-appブラウザ経路) | 2026-07-08実施 |
| `dogfood-log-2026-07-10.md` | ADR-0042最小ドッグフード経路の検証(2回目、実バックエンド構成+実題材、Playwright駆動) | 2026-07-10実施 |
