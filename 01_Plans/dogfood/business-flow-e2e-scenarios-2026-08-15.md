...
## カバレッジ集約（2026-08-16・iteration 122 時点）

**シナリオ56・チェック320**（E2E 実走行で確認）。業態カバレッジの集約:
