...
## カバレッジ集約（2026-08-16・iteration 120 時点）

**シナリオ55・チェック314**（E2E 実走行で確認）。業態カバレッジの集約:
...
| 公共・社会 | 政策立案（パブコメ）/ 災害対応（現場報告）/ NPO（ボランティア報告）/ NGO・国際協力（人道支援ニーズ）|
