...
## カバレッジ集約（2026-08-16・iteration 119 時点）

**シナリオ54・チェック308**（E2E 実走行で確認）。業態カバレッジの集約:
