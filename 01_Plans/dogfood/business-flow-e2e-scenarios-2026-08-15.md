...
## カバレッジ集約（2026-08-16・iteration 124 時点）

**シナリオ58・チェック333**（E2E 実走行で確認）。業態カバレッジの集約:
