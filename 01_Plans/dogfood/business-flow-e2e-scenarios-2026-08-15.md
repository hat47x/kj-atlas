...
## カバレッジ集約（2026-08-16・iteration 123 時点）

**シナリオ57・チェック327**（E2E 実走行で確認）。業態カバレッジの集約:
...
| 通信・IT | 通信IT（サポート問い合わせ）/ 通信キャリア（ネットワーク障害）|
