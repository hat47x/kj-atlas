...
## カバレッジ集約（2026-08-16・iteration 116 時点）

**シナリオ51・チェック287**（E2E 実走行で確認）。業態カバレッジの集約:
