...
- RequirementStatement: `Manual assisted mergeフロー` を 実装 の責務で前進させる。
...
- [ ] `FB-P2B-02` の実装責務と次段引き継ぎ条件が明文化される。
...
- 編集対象ファイル境界: `01_Plans/issues/issue-FB-P2B-02-a3-implementation.md` のみ。
