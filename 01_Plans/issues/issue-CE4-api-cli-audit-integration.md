...
## Stream E Execution Contract（2026-05-02 / CE4 API/CLI Audit Integration）

フェーズ順序は固定: **Read → ADR/CDC承認 → Plan → Execute → Verify（最大3回修復）→ Proceed/Stop**。
