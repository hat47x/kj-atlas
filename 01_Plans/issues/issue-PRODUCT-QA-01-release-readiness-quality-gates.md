...
- Side-panel diagnostics now use localized severity labels instead of exposing `ERROR` / `WARN` / `INFO`, and focus-reference actions reuse the localized focus label.
