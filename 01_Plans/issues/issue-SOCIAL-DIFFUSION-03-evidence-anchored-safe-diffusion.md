...
- Scope: `01_Plans/`, `02_Architecture/enterprise_architecture.html`, `03_Implement/frontend/src/export/`, `04_Documentation/security.md`
...
- [ ] T4 方式A/B境界の安全指針を `security.md` / `02_Architecture/enterprise_architecture.html` と同期する。
