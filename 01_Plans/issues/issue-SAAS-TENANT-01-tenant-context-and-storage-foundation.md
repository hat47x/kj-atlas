...
- [ ] AC-10: tenant A/Bへ同じdocIdを作成した越境negative matrixが、API/MCP/worker/browser cacheを含めて成功する。— 2026-08-13チェックポイントでAPI層に同一docId RLS matrixを追加したが、AI mutation種別ごとの実ブラウザ多タブ確認は`issue-SAAS-TENANT-E2E-01`所管の計装待ちであり、4次元の完全な網羅は未主張とする。
