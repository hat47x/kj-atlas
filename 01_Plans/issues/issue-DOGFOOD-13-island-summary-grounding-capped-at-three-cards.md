...
- Related ADR/Spec: `01_Plans/issues/issue-DOGFOOD-12-check-narrative-positive-path-hardcodes-island-i1.md`（同じくモックの暗黙制約）, `02_Architecture/api.md`（suggest-island-summary 契約・groundingIds）, `00_Prompt/kj_technique.md` §3（表札作成・接地）
