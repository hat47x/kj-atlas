...
- Related ADR/Spec: `AGENTS.md`（SafeMode既定ONは最優先の安全境界）, `01_Plans/adr/ADR-0058-document-contract-v1-rebaseline.md`, `02_Architecture/architecture.html`, `02_Architecture/schemas.md` §15.4, `THREAT_MODEL.md`
