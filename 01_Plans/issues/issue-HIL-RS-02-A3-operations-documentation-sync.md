...
### Phase 1: Read
- `02_Architecture/strict_mode_exception_approval_flow.html`（正本）と `04_Documentation/operations.md` / `security.md` / `security_operational_guidelines.md` の語彙・役割・導線・D1〜D4 を再確認。
...
- リンク整合:
  - 参照リンクは `ADR-0027`, `ADR-0028`, `02_Architecture/strict_mode_exception_approval_flow.html` のまま維持。
