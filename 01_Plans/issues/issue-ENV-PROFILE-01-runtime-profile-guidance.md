...
- `02_Architecture/enterprise_architecture.html` は strict mode を本番標準として扱う。
...
- `deployment.md` と `02_Architecture/enterprise_architecture.html` から profile guidance へ導線を追加する。
