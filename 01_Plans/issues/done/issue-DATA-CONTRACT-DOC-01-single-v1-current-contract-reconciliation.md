...
- `01_Plans/issues/done/issue-DATA-CONTRACT-RESET-01-document-v1-rebaseline.md`: Follow-upセクションを追記し、T1-T5のDone記録を過去の実装完了記録として保ったまま、文書側の回帰是正を本issueへ切り出したことを明記した。
