...
- Related ADR/Spec: `04_Documentation/canonicalization.md`, `02_Architecture/schemas.md`, `02_Architecture/architecture.html`
...
- Related ADR/Spec確認: 02_Architecture/schemas.md, 02_Architecture/architecture.html, 01_Plans/documentation_quality.md を参照し、00〜02の正本を上書きしない。
...
- 再読対象: Scope=`04_Documentation/canonicalization.md`、Related ADR/Spec（`02_Architecture/schemas.md`, `02_Architecture/architecture.html`）、Expected verification level=`docs-check` を再確認。
- 事前想定との差分ログ:
...
- Decision: **Move internal** を採用継続。`04_Documentation/canonicalization.md` は外部向け stub、詳細は `02_Architecture/schemas.md` / `02_Architecture/architecture.html` に集約する。
- Consequences:
