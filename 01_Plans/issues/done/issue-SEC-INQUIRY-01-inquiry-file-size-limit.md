...
- Related ADR/Spec: `01_Plans/adr/ADR-0046-responsiveness-performance-budget.md`, `01_Plans/adr/ADR-0057-w-type-cumulative-inquiry-model.md`, `02_Architecture/inquiry_journey_model.html`, `01_Plans/issues/done/issue-PERF-INQUIRY-01-representative-inquiry-import-non-blocking.md`
...
- 上限値を環境変数で調整可能にする場合、その名前は例外なく`SUI_`で始め、環境変数一覧へ追加する。
