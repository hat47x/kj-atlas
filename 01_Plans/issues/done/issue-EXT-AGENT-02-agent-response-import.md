...
- Related ADR/Spec: `01_Plans/adr/ADR-0049-external-flat-rate-agent-collaboration.md`（D3）, `02_Architecture/external_agent_collaboration_spec.html`（§4/§5 正本）, `01_Plans/issues/done/issue-CE3-patch-workspace-presets.md`
...
- Related: `01_Plans/issues/done/issue-EXT-AGENT-01-agent-task-package-export.md`, `issue-CE3-patch-workspace-presets.md`, `issue-QA-MONKEY-01-safemode-export-boundary.md`
