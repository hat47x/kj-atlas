...
- Related Backlog: `N/A`
- Related ADR/Spec: `00_Prompt/domain.md`, `00_Prompt/ai_cognitive_externalization_requirements.md`, `01_Plans/adr/ADR-0001-value-to-requirements.md`, `02_Architecture/architecture.html`, `02_Architecture/api.md`, `02_Architecture/schemas.md`
- Dependencies: N/A
...
- `02_Architecture/architecture.html` / `schemas.md` / `api.md` は実装者が参照する設計正本である。
...
- `02_Architecture/architecture.html` から value traceability へ導線を追加する。
...
- [x] `02_Architecture/architecture.html` と `AGENTS.md` から新規文書へ辿れる。
...
- [x] T2: `02_Architecture/architecture.html` に価値トレーサビリティ導線を追加する。
...
- `02_Architecture/architecture.html` に直接長い対応表を追加する:
  - 却下。最上位設計文書がさらに肥大化する。
...
- Result: `value_traceability.md` と `contract_reading_guide.md` を追加し、`02_Architecture/architecture.html` / `api.md` / `schemas.md` / `AGENTS.md` から導線を張った。
