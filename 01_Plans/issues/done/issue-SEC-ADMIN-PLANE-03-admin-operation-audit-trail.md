...
- Priority: P0
- Owner: Maintainer
- Scope: `03_Implement/backend/src/sui_sensemaking_api/routes/admin.py`, `03_Implement/backend/src/sui_sensemaking_api/audit.py`, `03_Implement/backend/src/sui_sensemaking_api/models.py`（`admin_audit_events` 新規）, migration, `02_Architecture/api.md`, `04_Documentation/security.md`
