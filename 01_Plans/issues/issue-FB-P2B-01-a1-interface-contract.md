# Issue Draft: FB-P2B-01-A1 Interface Contract（Stream E / FB-P2*）
...
- Unblocks: `issue-FB-P2B-01-a2-mock-validation.md`
- Blocked when: `DecisionStatus != Fixed`

## Interface Contract（Fixed）
- ContractID: `CTR-FB-P2B-01-V1`
- InputType:
  - `requestId: string`
  - `documentId: string`
  - `payload: object`
...
- AuditEvents（fixed names）:
  - `audit.fb-p2b-01.request_received`
  - `audit.fb-p2b-01.validation_passed`
  - `audit.fb-p2b-01.validation_failed`
  - `audit.fb-p2b-01.handoff_emitted`
