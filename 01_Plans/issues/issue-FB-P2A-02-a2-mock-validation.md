...
- RequirementStatement: `Collapse/Expand操作` を モック検証 の責務で前進させる。
...
- [ ] `FB-P2A-02` のモック検証責務と次段引き継ぎ条件が明文化される。
...
- 編集対象ファイル境界: `01_Plans/issues/issue-FB-P2A-02-a2-mock-validation.md` のみ。
