...
- Validation plan:
  ...
  - `rg -n "^\- Status:|^\- Priority:|Related Backlog|Expected verification level|VerificationLevel" 01_Plans/issues/issue-doc-ops-05-05-04doc-documentation-quality.md`
  - `git diff --check`
...
- Open化時の次アクション: `01_Plans/documentation_quality.md` を内部品質基準の正本として固定し、外部導線の必要最小参照だけを残す。


## Stream G dedicated 6-phase run（2026-04-27, DOC-OPS-05-05）
...
- 実施後方針: `01_Plans/documentation_quality.md` を内部品質基準の正本として固定し、外部導線は最小参照に限定。
