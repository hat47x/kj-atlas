# Issue Draft: FB-P2A-02-A1 Interface Contract（Stream E / FB-P2*）
...
- Unblocks: `issue-FB-P2A-02-a2-mock-validation.md`
...
- AuditEvents（fixed names）:
  - `audit.fb-p2a-02.request_received`
  - `audit.fb-p2a-02.validation_passed`
  - `audit.fb-p2a-02.validation_failed`
  - `audit.fb-p2a-02.handoff_emitted`
