...
- RequirementStatement: `Collapse/Expand操作` を インターフェース先行（型/契約） の責務で前進させる。
...
- [ ] `FB-P2A-02` のインターフェース先行（型/契約）責務と次段引き継ぎ条件が明文化される。
...
- 編集対象ファイル境界: `01_Plans/issues/issue-FB-P2A-02-a1-interface-contract.md` のみ。
