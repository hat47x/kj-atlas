# English Summary
This document defines a two-layer quality gate strategy: deterministic rule checks first, then optional low-cost local self-evaluation, plus a test taxonomy across unit, regression, and scheduled integration tests.
